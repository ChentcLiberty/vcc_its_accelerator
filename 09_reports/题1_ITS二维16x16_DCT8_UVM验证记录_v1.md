# 题1 ITS二维16x16 DCT8 UVM验证记录 v1

时间：`2026-05-22`

## 本轮目标

给通用 `ITS 2D 16x16` 壳子的 `DCT8 -> DCT8` 路径补一层轻量 `UVM`，把大块型二维共享壳子从 directed 推进到 `directed + UVM` 双层闭环。

## 新增文件

- [its_2d16_if.sv](../06_tb/uvm_its_2d16/its_2d16_if.sv)
- [its_2d16_uvm_pkg.sv](../06_tb/uvm_its_2d16/its_2d16_uvm_pkg.sv)
- [tb_its_2d16_uvm_top.sv](../06_tb/uvm_its_2d16/tb_its_2d16_uvm_top.sv)
- [run_vcs_its_2d16_uvm.sh](../08_scripts/run_vcs_its_2d16_uvm.sh)
- [题1_ITS二维16x16_DCT8_UVM验证说明_v1.md](../03_验证计划/题1_ITS二维16x16_DCT8_UVM验证说明_v1.md)
