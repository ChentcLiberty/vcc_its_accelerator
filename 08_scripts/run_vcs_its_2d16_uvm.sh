...
BUILD_DIR="/tmp/its_2d16_uvm_build"
SIMV="./its_2d16_uvm_simv"
...
/home/jjt/install/synopsys/vcs/vcs/T-2022.06/bin/vcs \
  ...
  "${ROOT_DIR}/06_tb/uvm_its_2d16/its_2d16_uvm_pkg.sv" \
  "${ROOT_DIR}/06_tb/uvm_its_2d16/tb_its_2d16_uvm_top.sv" \
  -o "${SIMV}"
