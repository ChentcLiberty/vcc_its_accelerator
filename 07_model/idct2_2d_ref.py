#!/usr/bin/env python3
"""Pure Python 2D IDCT2 reference model for Huawei Cup Problem 1."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run a simple 2D IDCT2 reference-model demo.")
