module tb_idct2_2d8_uvm_top;

    import uvm_pkg::*;
    import idct2_2d8_uvm_pkg::*;

    logic clk;

    idct2_2d8_if tb_if(.clk(clk));
    ...
    initial begin
        uvm_config_db#(virtual idct2_2d8_if)::set(null, "*", "vif", tb_if);
        run_test("idct2_2d8_uvm_test");
    end
