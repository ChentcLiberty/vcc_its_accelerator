module tb_lfnst_idct2_col4_core;
    ...
    task automatic init_expected_blocks;
        begin
            expected_bypass[0]  = 32'sd1792;
            expected_bypass[1]  = 32'sd2048;
            expected_bypass[2]  = 32'sd2304;
            expected_bypass[3]  = 32'sd2560;
            expected_bypass[4]  = -32'sd1140;
            expected_bypass[5]  = -32'sd1140;
            expected_bypass[6]  = -32'sd1140;
            expected_bypass[7]  = -32'sd1140;
            expected_bypass[8]  = 32'sd0;
            expected_bypass[9]  = 32'sd0;
            expected_bypass[10] = 32'sd0;
            expected_bypass[11] = 32'sd0;
            expected_bypass[12] = -32'sd100;
            expected_bypass[13] = -32'sd100;
            expected_bypass[14] = -32'sd100;
            expected_bypass[15] = -32'sd100;

            expected_lfnst[0]  = 32'sd448;
            expected_lfnst[1]  = -32'sd384;
            expected_lfnst[2]  = -32'sd704;
            expected_lfnst[3]  = -32'sd576;
            expected_lfnst[4]  = -32'sd1248;
            expected_lfnst[5]  = 32'sd855;
            expected_lfnst[6]  = -32'sd365;
            expected_lfnst[7]  = -32'sd108;
            expected_lfnst[8]  = 32'sd576;
            expected_lfnst[9]  = -32'sd512;
            expected_lfnst[10] = 32'sd1344;
            expected_lfnst[11] = -32'sd448;
            expected_lfnst[12] = 32'sd149;
            expected_lfnst[13] = 32'sd75;
            expected_lfnst[14] = -32'sd750;
            expected_lfnst[15] = 32'sd249;
        end
    endtask
    ...
    initial begin
        ...
        if (error_count != 0) begin
            $display("FAIL tb_lfnst_idct2_col4_core errors=%0d", error_count);
            $fatal;
        end

        $display("PASS tb_lfnst_idct2_col4_core");
        $finish;
    end
