module tb_lfnst_idct2_col4_uvm_top;

    import uvm_pkg::*;
    import lfnst_idct2_col4_uvm_pkg::*;

    logic clk;

    lfnst_idct2_col4_if tb_if(.clk(clk));
    ...
    initial begin
        uvm_config_db#(virtual lfnst_idct2_col4_if)::set(null, "*", "vif", tb_if);
        run_test("lfnst_idct2_col4_uvm_test");
    end
