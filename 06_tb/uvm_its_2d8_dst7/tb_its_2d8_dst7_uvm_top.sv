module tb_its_2d8_dst7_uvm_top;

    import uvm_pkg::*;
    import its_2d8_dst7_uvm_pkg::*;

    logic clk;

    its_2d8_if tb_if(.clk(clk));
    ...
    initial begin
        uvm_config_db#(virtual its_2d8_if)::set(null, "*", "vif", tb_if);
        run_test("its_2d8_dst7_uvm_test");
    end
