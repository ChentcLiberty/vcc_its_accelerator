package its_2d8_dst7_uvm_pkg;
    ...
    class its_2d8_smoke_seq extends uvm_sequence #(its_2d8_case);
        ...
        task body();
            int signed exp_full[64] = '{
                9160375, 2383170, 1571870, 925490, 629090, 368885, 362045, 110865,
                -1318885, -587390, -310866, -213502, -129582, -87599, -71959, -27107,
                290415, -8998, 20566, 1562, 6442, -243, 4613, -343,
                -290795, -155906, -77678, -55746, -32786, -23041, -18009, -7181,
                37905, -29146, -6998, -8986, -3626, -3981, -1669, -1321,
                -153805, -74502, -38330, -26870, -16070, -11063, -8879, -3435,
                61465, -3842, 3682, -306, 1054, -325, 819, -161,
                -58045, -26246, -13818, -9526, -5766, -3911, -3199, -1211
            };
            int signed exp_sparse[64] = '{
                448105, 798712, 369059, -65849, 27287, 217275, 73211, -118242,
                703099, 1249888, 568961, -114443, 38189, 341025, 112985, -188982,
                78818, 130376, 34222, -45346, -9242, 38550, 7150, -31284,
                -385133, -697592, -350959, 19453, -38899, -186375, -69223, 90090,
                -105496, -192664, -100928, 56, -12848, -51000, -19856, 23040,
                220425, 393000, 181875, -32025, 13575, 106875, 36075, -58050,
                19052, 32072, 9964, -9100, -1460, 9300, 2044, -6984,
                -217404, -390960, -189540, 20412, -18036, -105300, -37476, 53784
            };
    ...
    class its_2d8_dst7_uvm_test extends uvm_test;
        `uvm_component_utils(its_2d8_dst7_uvm_test)

        its_2d8_env env;

        function new(string name = "its_2d8_dst7_uvm_test", uvm_component parent = null);
            super.new(name, parent);
        endfunction
