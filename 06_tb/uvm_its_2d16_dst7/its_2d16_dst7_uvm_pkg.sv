package its_2d16_dst7_uvm_pkg;

    import uvm_pkg::*;
    `include "uvm_macros.svh"

    localparam string FULL_MEM =
        "/mnt/hgfs/wdchenaic/比赛/华为杯/02_题1_VVC_ITS/06_tb/data/its_2d16_dst7_full_expected.memh";
    localparam string SPARSE_MEM =
        "/mnt/hgfs/wdchenaic/比赛/华为杯/02_题1_VVC_ITS/06_tb/data/its_2d16_dst7_sparse_expected.memh";
    ...
    class its_2d16_smoke_seq extends uvm_sequence #(its_2d16_case);
        `uvm_object_utils(its_2d16_smoke_seq)

        function new(string name = "its_2d16_smoke_seq");
            super.new(name);
        endfunction
        ...
        task automatic load_expected_mem(
            ...
            $readmemh(FULL_MEM, full_mem);
            $readmemh(SPARSE_MEM, sparse_mem);
        ...
        task body();
            ...
            load_expected_mem(exp_full, exp_sparse);
            send_case(build_case("full16_case", 16, 16, 8, exp_full));
            send_case(build_case("sparse8_case", 8, 8, -1, exp_sparse));
        endtask
    endclass

    class its_2d16_dst7_uvm_test extends uvm_test;
        `uvm_component_utils(its_2d16_dst7_uvm_test)

        its_2d16_env env;

        function new(string name = "its_2d16_dst7_uvm_test", uvm_component parent = null);
            super.new(name, parent);
        endfunction
        ...
        task run_phase(uvm_phase phase);
            its_2d16_smoke_seq seq;
            phase.raise_objection(this);
            seq = its_2d16_smoke_seq::type_id::create("seq");
