module tb_its_1d_uvm_top;

    import uvm_pkg::*;
    import its_1d_uvm_pkg::*;

    logic clk;

    its_1d_if tb_if(.clk(clk));
    ...
    initial begin
        uvm_config_db#(virtual its_1d_if)::set(null, "*", "vif", tb_if);
        run_test("its_1d_uvm_test");
    end
